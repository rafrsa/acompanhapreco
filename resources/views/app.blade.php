...
<div class="page" >
    <div class="page-main">
            ...
            <div class="container">
                <div class="d-flex">
                    <a class="header-brand" href="#">
                        <img src="{{ URL::asset('images/logo-acompanhapreco.png') }}" class="header-brand-img" alt="Acompanha Preço logo">
                    </a>
                    <div class=" ">
                        {{--<form class="input-icon mt-2 ">--}}
                            ...
                            {{--</div>--}}
                            {{--<input type="search" class="form-control header-search" placeholder="Pesquisar&hellip;" tabindex="1">--}}
                        {{--</form>--}}
                    </div>
        ...
        <div class="admin-navbar" id="headerMenuCollapse">
            <div class="container">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" onclick="goListarProdutos()"><i class="fa fa-bar-chart"></i> <span>Cadastrar Produto</span></a>
                        {{--<div class="sub-item">--}}
                            {{--<ul>--}}
        ...
        <div class="my-3 my-md-5" id="dash-produtos-content">
            @include('lista_produtos')
        </div>
    </div>
